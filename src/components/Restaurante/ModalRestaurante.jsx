    ...
    return (
      <div className="fixed inset-0 flex justify-center items-center h-full shadow z-50 bg-modal">
        <div className=" fixed flex flex-col items-center m-10 w-full h-screen sm:w-auto sm:h-[600px] md:h-[500px]  lg:h-auto xl:m-0 xl:w-[1200px] xl:h-[580px] bg-branco  rounded">
          <div className="flex flex-col h-full /h-screen justify-center mt-1 md:mt-0 items-stretch  /bg-cinza-400 ">
            <button
            ...
            <footer className="/bg-vermelho my-3 flex items-center justify-end w-full h-20  absolute bottom-0 right-0  sm:p-5 sm:absolute sm:bottom-0 sm:right-0 md:justify-end /sm:justify-around sm:pr-10 ">
              <div className=" /bg-cinza flex items-center justify-center   h-20 w-full gap-3 p-10 overflow-hidden  sm:border-solid sm:border-t-2   border-gray sm:pr-0 sm:justify-end sm:ml-5 sm:gap-6 sm:w-full md:max-w-[300px] md:gap-6 md:ml-0 lg:max-w-sm xl:max-w-lg  ">
                <Contador
                  quantity={quantity}
